...
function procesar_estudiantes() {
    ...
    $estudiantes = fopen("Estudiantes.csv", "r"); // Abrir archivo en modo lectura
    ...
    $archivo_buenos = fopen("estudiantes_buenas.csv", "w"); // Abrir archivo en modo escritura
    ...
    $archivo_malos = fopen("estudiantes_malas.csv", "w"); // Abrir archivo en modo escritura
