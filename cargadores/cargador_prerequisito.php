...
function procesar_prerequisitos() {
    ...
    $prerequisitos = fopen("cargadores/originales/prerequisitos.csv", "r"); // Abrir archivo en modo lectura
    ...
    $archivo_buenos = fopen("data/prerequisitos_buenas.csv", "w"); // Abrir archivo en modo escritura
    ...
    $archivo_malos = fopen("data_malo/prerequisitos_malas.csv", "w"); // Abrir archivo en modo escritura
