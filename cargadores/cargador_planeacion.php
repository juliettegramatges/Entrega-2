...
function procesar_planeacion() {
    ...
    $planeacion = fopen("cargadores/originales/Planeación.csv", "r"); // Abrir archivo en modo lectura
    ...
    $archivo_buenos = fopen("data/planeacion_buenas.csv", "w"); // Abrir archivo en modo escritura
    ...
    $archivo_malos = fopen("data_malo/planeacion_malas.csv", "w"); // Abrir archivo en modo escritura
